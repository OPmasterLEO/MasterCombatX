...
public class FindPlayerManager implements CommandExecutor {
    ...
    public Map<String, Pair<String, String>> loadWorldMappings() { // Changed to public
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        // Dynamically fetch the latest world mappings from the configuration
        Map<String, Pair<String, String>> worldMap = loadWorldMappings();

        Pair<String, String> worldInfo;
        if (worldName.contains("duel")) {
            // Handle worlds containing "duel" dynamically
            worldInfo = new Pair<>("&#37BFF9", "ᴅᴜᴇʟ ᴍᴀᴛᴄʜ");
        } else {
            // Use the configured world mappings or default to UNKNOWN
